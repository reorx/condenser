...
- **condenser** owns everything else (`SCHEMA_VERSION` 20): reader state (`read_items` /
...
**The schema changelog (v3–v20), table details and migration conventions live in
...
- `kb/docs/database.md` — table ownership, `init_db` ordering traps, migration
  conventions, and the full schema changelog (v3–v20, newest first). Read before adding
