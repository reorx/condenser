...
- **condenser** owns everything else (`SCHEMA_VERSION` 19): reader state (`read_items` /
...
**The schema changelog (v3–v19), table details and migration conventions live in
...
- `kb/docs/database.md` — table ownership, `init_db` ordering traps, migration
  conventions, and the full schema changelog (v3–v19, newest first). Read before adding
